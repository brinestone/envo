...
import { lucideClock, lucideClockAlert, lucideComputer, lucideShieldCheck, lucideTrash2 } from '@ng-icons/lucide';
...
export class EnvironmentInfo {
  ...
  readonly stats: (EnvironmentStat & { icon: string; label: string; })[] = [
    { label: 'Clients', icon: 'lucideShieldCheck', count: 0, type: 'numeric' },
